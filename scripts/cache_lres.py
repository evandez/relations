...
from scripts.interpolation import save_order_1_approx
...
def main(
    ...
    mt = models.load_model(name=model_name, fp16=True, device="cuda")
    ...
    if h_layer is None:
        sweep_path = os.path.join("results/sweep-24-trials", model_name)
    ...
    save_order_1_approx(
        ...
        path=os.path.join(args.save_dir, model_name),
    )
...
if __name__ == "__main__":
    ...
    if args.rel_name is not None:
        ...
        for relation in dataset.relations[17:]:
